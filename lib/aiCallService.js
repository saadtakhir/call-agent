...
export function toSpokenForm(text) {
  ...
  // Any other number (sale-terms percentages, counts, years, etc. — the
  // agent's own free-form text, not a property id) is spelled out too,
  // since ElevenLabs otherwise reads digits it wasn't expecting oddly — e.g.
  // a thousands-separated "2 300" gets read as two separate numbers, "2"
  // then "300" ("ikki, uch yuz"), instead of "ikki ming uch yuz".
