 ...
 * arbitrary reply text — used for the "thinking_filler"/"searching_filler"
 * clips (see app/api/ai-call/filler/route.js), sent back by key rather
 * than by matching what the model happened to say. Returns
