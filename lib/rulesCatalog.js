  ...
  return [
    {
      ...
      rows: [
        ...
        computed("Vaqt — soat bog'lovchi -u bilan", "10:00 da", toSpokenForm),
        computed("Vaqt — unli bilan tugasa -yu", "12:15 da", toSpokenForm),
        computed("Vaqt — daqiqada nol saqlanadi", "9:05 da", toSpokenForm),
        ...
        computed("Tartib son (raqam-so'z)", "2-qavat", toSpokenForm),
        computed("Tartib son — sana va yil", "25-sentabr, 2026-yil", toSpokenForm),
        computed("Sifat qo'shimchasi (-li) — sanoq son bo'lib qoladi", "9-qavatli uy, 3-xonali kvartira", toSpokenForm),
        computed("\"-ta\" — sanoq son bo'lib qoladi", "3-ta xona", toSpokenForm),
        computed("Tartib son qo'shimchasi yozilgan (-chi, -inchi)", "5-chi sinf, 2-inchi qavat", toSpokenForm),
      ],
    },
    {
      id: "pronunciation",
    ...
    {
      id: "languages",
      title: "7. Tillar: aniqlash va raqamlar",
      intro:
        "AI uch tilda xizmat ko'rsatadi: o'zbek (asosiy), rus va ingliz. Har suhbat o'zbekcha boshlanadi. Tizim AI javobining tilini aniqlab, suhbat tilini eslab qoladi — keyingi gapni qaysi usulda matnga aylantirish shunga bog'liq. Rus va ingliz matnda raqamlar o'zbekcha so'zga aylantirilmaydi (ovoz modeli ularni o'zi to'g'ri o'qiydi), faqat birliklar so'zga almashtiriladi.",
      columns: COLUMNS_EXAMPLE,
      rows: [
        computed("AI javobi rus tilida — suhbat tili: rus", "Конечно, продолжим по-русски. Чем ещё могу помочь?", (v) => detectLanguage(v)),
        computed("AI javobi ingliz tilida — suhbat tili: ingliz", "Of course, we can continue in English. How can I help you?", (v) => detectLanguage(v)),
        computed("AI javobi o'zbekcha — suhbat tili: o'zbek", "Tushunarli, ID raqamingiz 142130, to'g'rimi?", (v) => detectLanguage(v)),
        computed("Til belgisi yo'q qisqa javob — til O'ZGARMAYDI", "ID 142130.", (v) => detectLanguage(v, { orNull: true }) || "(o'zgarmaydi, oldingi til qoladi)"),
        computed("Rus matnida: raqam raqamligicha, birliklar so'zga", "Цена 650 000 000 сумов, 544 m², 5%", toSpokenForm),
        computed("Ingliz matnida: raqam raqamligicha, birliklar so'zga", "Price is 650 000 000 sum, 544 m², 5%", toSpokenForm),
      ],
    },
    {
      id: "languages-behavior",
      title: "8. Tillar: xulq va ovozdan matnga o'tkazish",
      intro: "Bular kodda sozlangan xatti-harakatlar (AI'ga har javobda til siyosati avtomatik qo'shiladi, tahrirlangan System Message bo'lsa ham).",
      columns: ["Qoida", "Nima qiladi", "Misol"],
      rows: [
        { cells: ["Faqat 3 til", "Faqat o'zbek, rus va ingliz tillarida xizmat ko'rsatadi. Boshqa tilni (nemis, arab...) so'rasa, muloyimlik bilan shu uch tildan birini tanlashni so'raydi.", "Kechirasiz, men faqat o'zbek, rus va ingliz tillarida xizmat ko'rsata olaman."] },
        { cells: ["Til almashish", "Mijoz boshqa tilda gapirsa yoki so'rasa, o'sha tilga o'tadi; mijoz o'zbekchaga qaytsa, qaytadi.", "\"Rus tilida davom ettiring\" → ruscha javob"] },
        { cells: ["Mulk ma'lumoti tarjimasi", "Rus/ingliz tilida mulk ma'lumotini mazmunini o'zgartirmasdan tarjima qiladi; raqam, narx, ID va nomlar o'zgarmaydi. \"So'zma-so'z ayting\" qoidasi faqat o'zbekcha uchun.", "650 000 000 so'm → 650 000 000 сум"] },
        { cells: ["Qidiruv parametrlari", "Mijoz qaysi tilda gapirmasin, qidiruvga hudud va turni har doim o'zbekcha nom bilan yuboradi.", "regions: \"Xorazm viloyati\", category: \"kvartira\""] },
        { cells: ["Ovozdan matnga (o'zbek)", "Sozlamalarda tanlangan provayder ishlatiladi (Muxlisa, OpenAI yoki ElevenLabs).", "Ovoz tanish bo'limi"] },
        { cells: ["Ovozdan matnga (rus/ingliz)", "Suhbat rus/ingliz tiliga o'tgach, tanlangan provayderdan qat'i nazar avtomatik OpenAI ishlatiladi (Muxlisa faqat o'zbekcha tushunadi).", "Muxlisa tanlangan bo'lsa ham"] },
        { cells: ["Kutish va \"shu yerdamisiz?\" gaplari", "Suhbat tilida aytiladi (rus/inglizda tayyor o'zbekcha yozuvlar o'rniga jonli ovozlanadi).", "Одну минуту... / One moment..."] },
      ],
    },
    {
      id: "ai",
      title: "9. AI xulq qoidalari",
      intro:
    ...
    {
      id: "limits",
      title: "10. Joriy chegaralar va qiymatlar",
