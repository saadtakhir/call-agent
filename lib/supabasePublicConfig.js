...
// One shared broadcast topic for "the list of active calls just changed" —
// the Faol suhbatlar page (components/ActiveCallsPanel.jsx) subscribes and
// refetches on it; lib/callHangupRealtime.js sends it. Lives here (not
// there) because that file imports next/server, which a client component
// can't pull in.
export const ACTIVE_SESSIONS_CHANNEL = "active-sessions";
export const ACTIVE_SESSIONS_EVENT = "changed";
