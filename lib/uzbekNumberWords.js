...
/** 0-999 -> words. "yuz" alone for exactly one hundred (matches common
 * Uzbek usage — "yuz so'm", not "bir yuz so'm") — scale words above this
 * (ming/million/...) get an explicit "bir" prefix instead, in
 * numberToUzbekWords, since dropping it there reads as more ambiguous. */
